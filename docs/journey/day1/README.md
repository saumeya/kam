...
## Secrets
By default, [kam](https://github.com/redhat-developer/kam/releases) generates un-encrypted secrets. Deploying this GitOps configuration without encrypting the secrets is insecure and is not recommended.
